...
const variantClasses: Record<ActionSurfaceVariant, string> = {
  tile: 'flex flex-col items-start gap-2.5 rounded-xl border border-transparent bg-slate-50 p-3.5 text-start text-sm font-semibold text-slate-800 transition-all hover:border-primary-200 hover:bg-white hover:shadow-elevation-1',
  compact:
  ...
  row: 'flex w-full items-center justify-between gap-3 rounded-lg bg-white/60 px-3 py-2 text-right transition-colors hover:bg-white/90',
  plainRow: 'flex w-full items-center justify-between gap-3 px-3 py-2 text-right transition-colors hover:bg-slate-50',
  card: 'animate-fade-in rounded-xl border border-gray-200 bg-white p-5 text-right shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md',
  timelineGroup:
