...
import { DataTable, dateColumn, EmptyCell, monoColumn, textColumn, type Column } from '../../../components/ui/table'
import type { AnnualReportClientEntry, AnnualReportStatusGroup } from '../api'
import { getStatusLabel, getStatusVariant } from '@/features/annualReports'
...
const clientColumns: Column<AnnualReportClientEntry>[] = [
  ...
  }),
  {
    ...
    render: (r) => {
      ...
      const cls = d < 0 ? 'text-negative-600 font-semibold' : d <= 14 ? 'text-warning-600 font-semibold' : undefined
      return (
        <span className={cls}>
