...
const EVENT_REGISTRY: Record<string, EventMeta> = {
  ...
  annual_report_changed: { label: 'שינוי בדוח שנתי', icon: FilePen },
  client_created: { label: 'לקוח נוצר', icon: UserPlus },
  client_record_changed: { label: 'שינוי בפרטי לקוח', icon: UserCog },
  business_changed: { label: 'שינוי בפרטי עסק', icon: Building2 },
  charge_changed: { label: 'שינוי בחיוב', icon: CreditCard },
