...
export const AdvancePaymentReadonlySections: React.FC<AdvancePaymentReadonlySectionsProps> = ({ model }) => (
  <DrawerSection title={ADVANCED_PAYMENTS_MESSAGES.readonlySections.sectionTitle}>
    <DrawerField label={ADVANCED_PAYMENTS_MESSAGES.readonlySections.paidAmountLabel} value={formatShekelAmount(model.paidAmount)} />
    <DrawerField label={ADVANCED_PAYMENTS_MESSAGES.readonlySections.expectedAmountLabel} value={formatShekelAmount(model.expectedAmount)} />
    <DrawerField
    ...
    />
    <DrawerField label={ADVANCED_PAYMENTS_MESSAGES.readonlySections.advanceRateLabel} value={formatAdvanceRate(model.advanceRate)} />
    <DrawerField
    ...
    />
    <DrawerField label={ADVANCED_PAYMENTS_MESSAGES.readonlySections.paidAtLabel} value={model.paidAt ? formatDate(model.paidAt) : null} />
