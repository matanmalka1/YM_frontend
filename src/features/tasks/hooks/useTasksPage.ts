...
export const useTasksPage = () => {
  ...
  return {
    ...
    setAssignedRoleFilter: filters.setAssignedRoleFilter,
    setAssignedUserFilter: filters.setAssignedUserFilter,
    setSourceDomainFilter: filters.setSourceDomainFilter,
    setDueAfterFilter: filters.setDueAfterFilter,
    setDueBeforeFilter: filters.setDueBeforeFilter,
